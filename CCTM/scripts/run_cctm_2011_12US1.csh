...
# Usage: run.cctm >&! cctm_2011_12US1.log &                                
#
...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = 2011_CONUS        #> Application Name (e.g. Gridname)
...
#> Set Working, Input, and Output Directories
 ...
 setenv INPDIR  /work/MOD3DATA/2011_12US1  #Input Directory
...
#> Set Start and End Days for looping
 ...
 set START_DATE = "2011-06-21"     #> beginning date (July 1, 2011)
 set END_DATE   = "2011-06-21"     #> ending date    (July 14, 2011)
...
set ICpath    = $INPDIR/icbc/cb6r3_ae6/icon   #> initial conditions input directory 
set BCpath    = $INPDIR/icbc/cb6r3_ae6/bcon   #> boundary conditions input directory
set EMISpath  = $INPDIR/emis/cb6r3_ae6/cmaq_ready/gridded #> gridded emissions input directory
set IN_PTpath = $INPDIR/emis/cb6r3_ae6/cmaq_ready #> point source emissions input directory
set IN_LTpath = $INPDIR/lightning         #> lightning NOx input directory
set METpath   = $INPDIR/met/mcip_v43_wrf_v38_ltng          #> meteorology input directory 
...
# =====================================================================
  ...
  #> Boundary conditions
  set BCFILE = BCON.geos2cmaq.${YYYYMM}.ncf
...
#  setenv LUFRAC_CRO $METpath/LUFRAC_CRO_${YYYYMMDD}
  ...
  setenv STK_GRPS_001 $IN_PTpath/stack_groups/stack_groups_ptnonipm_${STKCASEG}.ncf
  setenv STK_GRPS_002 $IN_PTpath/stack_groups/stack_groups_ptegu_${STKCASEG}.ncf
  setenv STK_GRPS_003 $IN_PTpath/stack_groups/stack_groups_othpt_${STKCASEG}.ncf
  setenv STK_GRPS_004 $IN_PTpath/stack_groups/stack_groups_ptfire_${YYYYMMDD}_${STKCASEG}.ncf
  setenv STK_GRPS_005 $IN_PTpath/stack_groups/stack_groups_pt_oilgas_${STKCASEG}.ncf
  ...
  setenv STK_EMIS_005 $IN_PTpath/pt_oilgas/inln_mole_pt_oilgas_${YYYYMMDD}_${STKCASEE}.ncf
  ...
  if ( $CTM_ABFLUX == 'Y' ) then
     ...
     setenv E2C_SOIL ${INPDIR}/surface/epic_festc1.4/epic2011_20180516_soil.nc
     setenv E2C_CHEM ${INPDIR}/surface/epic_festc1.4/epic2011_20180516_time${YYYYMMDD}.nc
